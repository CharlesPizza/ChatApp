...
ip_addr.grid(column=1, row=0, sticky=(W))
...
eport.grid(column=1, row=1,sticky=(W))
eport.insert(0, 9000)
...
iport.grid(column=1, row=2,sticky=(W))
iport.insert(0, 9000)
...
launch_btn.grid(column=0, row=3, columnspan=2, sticky=(W,E))
